// netplay.c : Defines the entry point for the console application.
//
...
int _GameLoop(NetClientT *pClient)
{
	...
	/* set timer event */
	hTimer = timeSetEvent(1000/60, 0, (LPTIMECALLBACK)hEvent, (DWORD_PTR)NULL, TIME_PERIODIC | TIME_CALLBACK_EVENT_SET);
